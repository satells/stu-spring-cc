					...
					<tr>
						...
						<td class="remove-item">
							<form action="${s:mvcUrl('CCC#remover').arg(0,item.produto.id).arg(1,item.tipoPreco).build()}" method="POST">
								<input type="submit" src="${contextPath }/resources/imagens/excluir.png" 
									alt="Excluir" title="Excluir"  >Excluir</input>
							</form>	
						</td>
					</tr>
				</c:forEach>
			...
			<tfoot>
				<tr>
					...
					<form action="${s:mvcUrl('PC#finalizar').build()}" method="POST">
						<input type="submit" class="checkout" name="checkout" value="Finalizar compra" >Finalizar</input>
						</form>
